#!/bin/bash
echo -e "\033[32mPlease select the hysteria version to install:\n\n\033[0m\033[33m\033[01m1. hysteria2 (Recommended, LTS, better performance)\n2. hysteria1 (NLTS, no future feature updates, but supports faketcp. Use this if UDP is QoS'd)\033[0m\033[32m\n\nEnter number:\033[0m"
...
if [ "$hysteria_version" = "1" ] || [ -z "$hysteria_version" ]; then
    ...
    echo -e "\033[31mInvalid input, please re-run the script\033[0m"
    exit 1
fi
echo -e "-> Selected hysteria version: \033[32m$hysteria_version\033[0m"
